...
namespace Result_Analysis
{
    public partial class Text_Analysis : Form
    {
            ...
            try
            {
                ...
                if (dlg.ShowDialog() != DialogResult.Cancel)
                {
                    ...
                    if (stat == 1)
                    {
                        ...
                        txtFile1_Content.Text = reader.ReadToEnd();
                    }
                    if (stat == 2)
                    {
                        txtFile2_Path.Text = dlg.FileName;
                        txtFile2_Content.Text = reader.ReadToEnd();
                    }
                    reader.Close();
                }                
            }
        ...
        private void linkText_Analysis_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
